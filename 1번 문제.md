...
Transaction Isolation Level은 다음과 같으며, 아래로 갈수록 isolation level이 높아져 더 많은 Lock을 걸어 동시성이 떨어지게 됩니다. (반대로 위로 올라올수록 isolation level이 낮아지고 더 적은 Lock을 사용해 동시성을 확보합니다.)
